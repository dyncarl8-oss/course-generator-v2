...
import { type CourseWithModules, type Quiz, type MediaItem } from "@shared/schema";
                                                        ...
                                                        if (file) {
                                                          ...
                                                          reader.onload = async () => {
                                                            ...
                                                            try {
                                                              ...
                                                              queryClient.setQueryData(["/api/dashboard", companyId, "courses", courseId], (old: CourseWithModules) => ({
                                                                ...old,
                                        ...
                                        {isEditMode ? (
                                          <>
                                            <div
                                              ...
                                              className="text-base leading-relaxed text-muted-foreground outline-none rounded transition-colors whitespace-pre-wrap min-h-[1.5em] cursor-text focus:bg-muted/30 focus:p-3 focus:-m-3"
                                              data-testid={`textarea-lesson-${lesson.id}`}
                                              data-placeholder="Click to add content..."
                                            >
                                              {lesson.content}
                                            </div>
                                            {!lesson.content && (
                                              <div className="absolute inset-0 text-muted-foreground/50 pointer-events-none select-none">
                                                Click to add content...
                                              </div>
                                            )}
                                            {lesson.media && lesson.media.length > 0 && (
                                              <div className="mt-4 space-y-3">
                                                {lesson.media.map(renderMedia)}
                                              </div>
                                            )}
                                          </>
                                        ) : (
